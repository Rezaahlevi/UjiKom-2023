        <div class="row">
          <div class="col s12 m9">
            <h3 class="orange-text">Registerasi Masyarakat Melalui Admin</h3>
          </div>  
          <div class="col s12 m3">
            <div class="section"></div>
            <a class="waves-effect waves-light btn modal-trigger blue" href="#modal1">TAMBAH</a>
          </div>
        </div>
	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn green modal-trigger" href="#regis_edit?nik=<?php echo $r['nik'] ?>">Edit</a> <a onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" class="btn red" href="index.php?p=regis_hapus&nik=<?php echo $r['nik'] ?>">Hapus</a></td>
