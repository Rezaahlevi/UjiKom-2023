<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(../img/ay.jpg); background-size: cover;">
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#name"><span class="black-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a>
                  </div>
              </li>
              <li><a href="index.php?p=dashboard">Beranda</a></li>
              <li><a href="index.php?p=registrasi">Registrasi Masyarakat</a></li>
              <li><a href="index.php?p=pengaduan">Pengaduan</a></li>
              <li><a href="index.php?p=respon">Respon</a></li>
              <li><a href="index.php?p=user">Registrasi Admin/Staff</a></li>
