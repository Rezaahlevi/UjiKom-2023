          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#user"><img class="circle" src="../img/userbg.png"></a>
                      <a href="#name"><span class="black-text name"><?php echo ucwords($_SESSION['data']['nama']); ?></span></a>
                  </div>
              </li>
              <li><a href="index.php?p=dashboard"><i class="material-icons">home</i>Beranda</a></li>
              <li><a href="index.php?p=membuat laporan"><i class="material-icons">book</i>Membuat Laporan</a></li>
              <li>
