                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item">
                        ...
                        <div class="carousel-caption">
                            <h2 class="animated bounceInDown">masyarakat</h2>
                        </div>
                    </div>
                    <div class="item">
                        <img src="img/je.png" alt="...">
                        <div class="carousel-caption">
                            <h2 class="animated bounceInUp">pejabat</h2>
                        </div>
                    </div>
                </div>
...
<ul>
    <li>
        Masukan data pribadi dan pengaduan Anda di <a href="lapor">sini</a>
    </li>
    <li>
    ...
    <li>
        ...
        <a href="kontak">Bagian Pengaduan Masyarakat</a>
    </li>
</ul>
<p>&nbsp;</p>
<p>
...
<ul>
    <li>
        ...
        <a href="kontak">Bagian Hubungan Masyarakat</a>
        Dispendukcapil Bangkalan
    </li>
    <li>
